...
tree_node* IP_literal(tree_node* parent) {
    ...
    // }
    if (
        check_sa(node_IP_literal, "[")!=NULL &&
        (IPv6address(node_IP_literal)!=NULL || IPvFuture(node_IP_literal)!=NULL) &&
        check_sa(node_IP_literal, "]")!=NULL) {
